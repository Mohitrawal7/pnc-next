...
function Form() {
    return(
        ...
        <div className="mt-3 text-center text-4xl font-bold">Make an recipe</div>
        <div className="p-8">
          ...
          <div className="">
            <textarea name="textarea" id="text" cols="30" rows="10" className="mb-10 h-40 w-full resize-none rounded-md border border-slate-300 p-5 font-semibold text-gray-300" defaultValue="Description"></textarea>
          </div>
